<div class="min-h-screen flex flex-col p-4 sm:p-[2%] overflow-hidden">
    ...
    <div class="space-y-6 flex-1">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div id="form-pembayaran" class="max-h-[calc(100vh-0.5vh)] overflow-y-auto bg-theme-surface pb-6 rounded-lg shadow-lg border-2 border-theme-primary" style="border-color: #007022;">
                <x-card-header 
