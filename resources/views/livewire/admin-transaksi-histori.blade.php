<div class="min-h-screen flex flex-col p-4 sm:p-[2%] overflow-hidden">
        ...
        <div class="mb-4 flex space-x-4">
            ...
            <div>
                <div class="relative rounded-md shadow-sm border border-gray-300">
                    ...
                    <select wire:model.live="filter_metode_pembayaran" id="filter_metode_pembayaran" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:border-theme-primary focus:ring focus:ring-theme-primary focus:ring-opacity-50">
    ...
    @if($editingTransactionId)
        <div class="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-theme-surface p-6 rounded-lg shadow-lg border-2 border-theme-primary w-full max-w-lg">
                <h3 class="text-xl font-medium text-theme-black mb-4 flex items-center space-x-3">
                    <svg class="w-5 h-5 text-theme-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm border border-gray-300">
                                ...
                                <input wire:model="editingDate" id="editingDate" type="date" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:border-theme-primary focus:ring focus:ring-theme-primary focus:ring-opacity-50" required>
                            </div>
                        </div>
                            ...
                            <div class="border-t pt-4">
                                @if($detail['barang_id'])
                                    ...
                                    <div class="mt-1 relative rounded-md shadow-sm border border-gray-300">
                                        ...
                                        <input wire:model="editingDetails.{{ $index }}.jumlah" type="number" min="1" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:border-theme-primary focus:ring focus:ring-theme-primary focus:ring-opacity-50" required>
                                    </div>
                                @else
                                    ...
                                    <div class="mt-1 relative rounded-md shadow-sm border border-gray-300">
                                        ...
                                        <input wire:model="editingDetails.{{ $index }}.keterangan" id="keterangan_{{ $index }}" type="text" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:border-theme-primary focus:ring focus:ring-theme-primary focus:ring-opacity-50" required>
                                    </div>
                                    ...
                                    <div class="mt-1 relative rounded-md shadow-sm border border-gray-300">
                                        ...
                                        <input wire:model="editingDetails.{{ $index }}.subtotal" id="subtotal_{{ $index }}" type="number" min="0" step="0.01" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:border-theme-primary focus:ring focus:ring-theme-primary focus:ring-opacity-50" required>
                                    </div>
                                @endif
